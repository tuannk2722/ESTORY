...
import { chapterContextSchema, replaceContentSchema, updateChapterSchema, chapterSchema } from "@/lib/validation/story-command-schema";
...
export const PATCH = storyMutationRoute({
  scope: "chapter", body: updateChapterSchema.omit(contextFields), output: chapterSchema,
