...
import { replaceEditorSchema, editorBootstrapDataSchema, editorDataSchema } from "@/lib/validation/story-command-schema";

export const GET = storyReadRoute(editorBootstrapDataSchema, "editor");
