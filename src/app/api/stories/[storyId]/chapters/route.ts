...
import { createChapterSchema, managedChapterSchema } from "@/lib/validation/story-command-schema";

export const POST = storyMutationRoute({
  scope: "story", body: createChapterSchema.omit({ actorId: true, storyId: true }), output: managedChapterSchema, status: 201,
