...
for (const file of scripts) {
  ...
  assert.ok(!/PrismaClient|PrismaPg|@prisma\/client|freesoundAccessTokenCiphertext|DATABASE_URL/.test(source), `Server database code found in browser bundle: ${file}`);
}
