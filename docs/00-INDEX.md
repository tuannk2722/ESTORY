...
- **Tiến độ đã xác minh:** [verification/](verification/), gồm [P3-00](verification/p3-00.md), [P3-01](verification/p3-01.md), [P3-02](verification/p3-02.md), [P3-03](verification/p3-03.md), [P3-04](verification/p3-04.md) và [P3-05](verification/p3-05.md) (local/Neon dev pass; kiểm tra bên ngoài ghi riêng); đối chiếu git/code khi tiếp tục. Checkbox trong user stories là tiêu chí, không phải bảng tiến độ tự cập nhật.
